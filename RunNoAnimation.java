...
//	private int files = 1;
	...
	public void run()
	{
		...
		run.csv.close("Rs" + (int)run.sensingRange + " Rc" + (int)run.communicationRange + " N" + run.sensorCount +  " T" + run.detectionThreshold + " " + run.mouseAlgorithmType, header);
	}
	...
	public void runForGraph()
	{
		...
		run.csv.close("Rs" + (int)run.sensingRange + " Rc" + (int)run.communicationRange + " N" + run.sensorCount + run.mouseAlgorithmType + " T" + run.detectionThreshold + " #", header);
	}
