...
//				looper.run.formatResults();
    ...
    public int getT1SensorCount() {
        return Integer.parseInt(formatNumberString(tField_sns1Cnt.getText()));
    }

    // Returns a parsed float for the Type 1 sensor sensing range
    public int getT1SensingRange() {
        return Integer.parseInt(formatNumberString(tField_sns1Rng.getText()));
    }

    // Returns a parsed float for the Type 1 sensor communication range
    public int getT1CommunicationRange() {
        return Integer.parseInt(formatNumberString(tField_cmn1Rng.getText()));
    }

    // Returns a parsed integer for the Type 2 sensor count
    public int getT2SensorCount() {
        return Integer.parseInt(formatNumberString(tField_sns2Cnt.getText()));
    }

    // Returns a parsed float for the Type 2 sensor sensing range
    public int getT2SensingRange() {
        return Integer.parseInt(formatNumberString(tField_sns2Rng.getText()));
    }

    // Returns a parsed float for the Type 2 sensor communication range
    public int getT2CommunicationRange() {
        return Integer.parseInt(formatNumberString(tField_cmn2Rng.getText()));
    }

    // Returns a parsed float for the intruder sensing range
    public int getIntruderSensingRange() {
        return Integer.parseInt(formatNumberString(tField_itrSns.getText()));
    }

    // Returns a parsed int for the detection threshold
    public int getDetectionThreshold() {
        return Integer.parseInt(formatNumberString(tField_dtcThr.getText()));
    }

    // Returns a parsed int for the field width
    public int getFieldWidth() {
        return Integer.parseInt(formatNumberString(tField_fieldW.getText()));
    }

    // Returns a parsed int for the field height
    public int getFieldHeight() {
        return Integer.parseInt(formatNumberString(tField_fieldH.getText()));
    }

    // Returns a parsed int for the number of iterations to be ran
    public int getIterationsNum() {
        return Integer.parseInt(formatNumberString(tField_itrCnt.getText()));
    }

    // Returns the type of mouse movement algorithm
    public String getAlgorithmType() {
        return choice_itrAlg.getSelectedItem();
    }

    // Returns the type of sensor detection
    public String getDetectionType() {
        return choice_dtcTyp.getSelectedItem();
    }
